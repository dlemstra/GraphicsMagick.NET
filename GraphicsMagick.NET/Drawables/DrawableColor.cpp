...
{
	//==============================================================================================
	DrawableColor::DrawableColor(double x, double y, GraphicsMagick::PaintMethod paintMethod)
	{
		BaseValue = new Magick::DrawableColor(x, y, (Magick::PaintMethod)paintMethod);
	}
	//==============================================================================================
	GraphicsMagick::PaintMethod DrawableColor::PaintMethod::get()
	{
		return (GraphicsMagick::PaintMethod)Value->paintMethod();
	}
	//==============================================================================================
	void DrawableColor::PaintMethod::set(GraphicsMagick::PaintMethod value)
	{
