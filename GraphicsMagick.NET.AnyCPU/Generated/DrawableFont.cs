...
{
	public sealed class DrawableFont: Drawable
	{
		internal DrawableFont(object instance)
			: base(instance)
		{
		}
		...
		public String Family
		{
			get
			{
				...
				try
				{
					result = _Instance.GetPropertyValue("Family");
				}
				catch (Exception ex)
				{
			...
			set
			{
				try
				{
					_Instance.SetPropertyValue("Family", value);
				}
				catch (Exception ex)
				{
					throw ExceptionHelper.Create(ex);
