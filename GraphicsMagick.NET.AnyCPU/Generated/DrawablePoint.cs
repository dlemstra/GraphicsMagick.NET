...
{
	public sealed class DrawablePoint: Drawable
	{
		internal DrawablePoint(object instance)
			: base(instance)
		{
		}
		public DrawablePoint(Double x, Double y)
			: base(AssemblyHelper.CreateInstance(Types.DrawablePoint, new Type[] {typeof(Double), typeof(Double)}, x, y))
		{
		}
		public Double X
		{
