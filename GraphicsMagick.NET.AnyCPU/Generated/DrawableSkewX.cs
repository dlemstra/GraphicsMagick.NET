...
{
	public sealed class DrawableSkewX: Drawable
	{
		internal DrawableSkewX(object instance)
			: base(instance)
		{
		}
		public DrawableSkewX(Double angle)
			: base(AssemblyHelper.CreateInstance(Types.DrawableSkewX, new Type[] {typeof(Double)}, angle))
		{
		}
		public Double Angle
		{
