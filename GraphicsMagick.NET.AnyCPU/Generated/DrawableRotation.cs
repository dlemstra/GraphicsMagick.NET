...
{
	public sealed class DrawableRotation: Drawable
	{
		internal DrawableRotation(object instance)
			: base(instance)
		{
		}
		public DrawableRotation(Double angle)
			: base(AssemblyHelper.CreateInstance(Types.DrawableRotation, new Type[] {typeof(Double)}, angle))
		{
		}
		public Double Angle
		{
