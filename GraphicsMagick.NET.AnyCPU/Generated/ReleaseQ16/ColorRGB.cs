...
namespace GraphicsMagick
{
	public sealed class ColorRGB: ColorBase
	{
		...
		[CLSCompliant(false)]
		public ColorRGB(UInt16 red, UInt16 green, UInt16 blue)
			: base(AssemblyHelper.CreateInstance(Types.ColorRGB, new Type[] {typeof(UInt16), typeof(UInt16), typeof(UInt16)}, red, green, blue))
		{
		}
		[CLSCompliant(false)]
		public UInt16 B
