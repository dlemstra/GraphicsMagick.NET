...
namespace GraphicsMagick
{
	public sealed class MagickImage: IDisposable, IEquatable<MagickImage>, IComparable<MagickImage>
	{
		...
		[CLSCompliant(false)]
		public void Level(UInt16 blackPoint, UInt16 whitePoint, Double midpoint, Channels channels)
		{
			try
			{
				_Instance.CallMethod("Level", new Type[] {typeof(UInt16), typeof(UInt16), typeof(Double), Types.Channels}, blackPoint, whitePoint, midpoint, channels);
			}
			catch (Exception ex)
			{
				throw ExceptionHelper.Create(ex);
		...
		[CLSCompliant(false)]
		public void Level(UInt16 blackPoint, UInt16 whitePoint, Double midpoint)
		{
			try
			{
				_Instance.CallMethod("Level", new Type[] {typeof(UInt16), typeof(UInt16), typeof(Double)}, blackPoint, whitePoint, midpoint);
			}
			catch (Exception ex)
			{
				throw ExceptionHelper.Create(ex);
		...
		[CLSCompliant(false)]
		public void Level(UInt16 blackPoint, UInt16 whitePoint, Channels channels)
		{
			try
			{
				_Instance.CallMethod("Level", new Type[] {typeof(UInt16), typeof(UInt16), Types.Channels}, blackPoint, whitePoint, channels);
			}
			catch (Exception ex)
			{
				throw ExceptionHelper.Create(ex);
		...
		[CLSCompliant(false)]
		public void Level(UInt16 blackPoint, UInt16 whitePoint)
		{
			try
			{
				_Instance.CallMethod("Level", new Type[] {typeof(UInt16), typeof(UInt16)}, blackPoint, whitePoint);
			}
			catch (Exception ex)
			{
				throw ExceptionHelper.Create(ex);
		...
		[CLSCompliant(false)]
		public void RandomThreshold(UInt16 low, UInt16 high, Channels channels)
		{
			try
			{
				_Instance.CallMethod("RandomThreshold", new Type[] {typeof(UInt16), typeof(UInt16), Types.Channels}, low, high, channels);
			}
			catch (Exception ex)
			{
				throw ExceptionHelper.Create(ex);
		...
		[CLSCompliant(false)]
		public void RandomThreshold(UInt16 low, UInt16 high)
		{
			try
			{
				_Instance.CallMethod("RandomThreshold", new Type[] {typeof(UInt16), typeof(UInt16)}, low, high);
			}
			catch (Exception ex)
			{
				throw ExceptionHelper.Create(ex);
