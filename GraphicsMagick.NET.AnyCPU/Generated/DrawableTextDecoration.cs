...
{
	public sealed class DrawableTextDecoration: Drawable
	{
		internal DrawableTextDecoration(object instance)
			: base(instance)
		{
		}
		...
		public TextDecoration Decoration
		{
			get
			{
				...
				try
				{
					result = _Instance.GetPropertyValue("Decoration");
				}
				catch (Exception ex)
				{
					throw ExceptionHelper.Create(ex);
				}
				return (TextDecoration)result;
			}
			set
			{
				try
				{
					_Instance.SetPropertyValue("Decoration", value);
				}
				catch (Exception ex)
				{
					throw ExceptionHelper.Create(ex);
