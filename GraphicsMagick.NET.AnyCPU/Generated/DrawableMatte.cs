...
{
	public sealed class DrawableMatte: Drawable
	{
		internal DrawableMatte(object instance)
			: base(instance)
		{
		}
		...
		public PaintMethod PaintMethod
		{
			get
			{
				...
				try
				{
					result = _Instance.GetPropertyValue("PaintMethod");
				}
				catch (Exception ex)
				{
					throw ExceptionHelper.Create(ex);
				}
				return (PaintMethod)result;
			}
			set
			{
				try
				{
					_Instance.SetPropertyValue("PaintMethod", value);
				}
				catch (Exception ex)
				{
					throw ExceptionHelper.Create(ex);
