...
{
	public sealed class DrawableGravity: Drawable
	{
		internal DrawableGravity(object instance)
			: base(instance)
		{
		}
		...
		public Gravity Gravity
		{
			get
			{
				...
				try
				{
					result = _Instance.GetPropertyValue("Gravity");
				}
				catch (Exception ex)
				{
			...
			set
			{
				try
				{
					_Instance.SetPropertyValue("Gravity", value);
				}
				catch (Exception ex)
				{
					throw ExceptionHelper.Create(ex);
