...
{
	public sealed class DrawableArc: Drawable
	{
		internal DrawableArc(object instance)
			: base(instance)
		{
		}
		public DrawableArc(Double startX, Double startY, Double endX, Double endY, Double startDegrees, Double endDegrees)
			: base(AssemblyHelper.CreateInstance(Types.DrawableArc, new Type[] {typeof(Double), typeof(Double), typeof(Double), typeof(Double), typeof(Double), typeof(Double)}, startX, startY, endX, endY, startDegrees, endDegrees))
		{
		}
