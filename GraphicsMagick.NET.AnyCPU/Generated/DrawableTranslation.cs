...
{
	public sealed class DrawableTranslation: Drawable
	{
		internal DrawableTranslation(object instance)
			: base(instance)
		{
		}
		public DrawableTranslation(Double x, Double y)
			: base(AssemblyHelper.CreateInstance(Types.DrawableTranslation, new Type[] {typeof(Double), typeof(Double)}, x, y))
		{
		}
		public Double X
		{
