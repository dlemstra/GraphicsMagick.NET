...
{
	public sealed class DrawableTextUnderColor: Drawable
	{
		internal DrawableTextUnderColor(object instance)
			: base(instance)
		{
		}
		...
		public DrawableTextUnderColor(Color color)
			: base(AssemblyHelper.CreateInstance(Types.DrawableTextUnderColor, new Type[] {typeof(Color)}, color))
		{
		}
