...
namespace GraphicsMagick
{
	public sealed class ScriptReadEventArgs: EventArgs
	{
		...
		internal ScriptReadEventArgs(object instance)
		{
			_Instance = instance;
		}
		...
		public static object GetInstance(object obj)
		{
			if (ReferenceEquals(obj, null))
				return null;
			ScriptReadEventArgs casted = obj as ScriptReadEventArgs;
		...
		public MagickImage Image
		{
			...
			set
			{
				try
				{
					_Instance.SetPropertyValue("Image", MagickImage.GetInstance(value));
				}
				catch (Exception ex)
				{
					throw ExceptionHelper.Create(ex);
		...
		public MagickReadSettings Settings
		{
			get
			{
				...
				try
				{
					result = _Instance.GetPropertyValue("Settings");
				}
				catch (Exception ex)
				{
					throw ExceptionHelper.Create(ex);
				}
				return (result == null ? null : new MagickReadSettings(result));
			}
		}
	}
}
