...
{
	//==============================================================================================
	internal class GraphicsMagickNET
	{
		//===========================================================================================
		...
		{
			return from type in _GraphicsMagickNET.GetTypes()
		...
		{
			foreach (string resourceName in from name in _GraphicsMagickNET.GetManifestResourceNames()
													  orderby name
													  select name)
			{
